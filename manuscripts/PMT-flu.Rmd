...
```

Seasonal influenza is a major contributor to ill health and lost productivity, with an estimated annual direct cost to healthcare of $3.5 billion in the United States alone [@yan2017us], and is a significant contributor to early mortality particularly among the elderly [@thompson2006epidemiology]. Vaccination is an effective strategy for the minimisation of related harms, with 2016-17 vaccination reducing the risk by an estimated 48% [@flannery2017], and well-matched vaccination estimated to reduce all-cause mortality in nursing home residents by 2% [@popvicas15]. The Centers for Disease Control and Prevention (CDC) recommends yearly seasonal influenza vaccination for all persons aged $\geq$ 6 months who do not have contraindications [@Grohskopf_2018]. Despite this, vaccination uptake remains low, with an annual average coverage in the United States of 46.8% [@CDC2018]. This is well below the Healthy People 2020 target for 70% uptake of the seasonal influenza vaccination among non-institutionalised adults [@healthy2020].
...
- A single study listing both studies was created on Amazon MTurk
- Interested participants read a plain language statement that was relevant to both studies
- Consenting participants were directed to a single Qualtrics survey that contained the materials for both projects
...
These items included questions regarding age, gender, highest level of education completed, annual household income, and political ideology. Consistent with PMT, where demographic variables are thought to influence intention and behaviour indirectly through their influence on other PMT constructs, these factors were included for the purpose of describing the sample but not included in analyses.
